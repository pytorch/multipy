...
public:
  ...
  virtual multipy::optional<at::IValue>
  toTypeInferredIValue(py::handle input) = 0;
  ...
  virtual multipy::optional<PyObject *>
  createPyObject(const at::Storage &storage) = 0;

  // return the `THPDtype` of `scalarType`
  virtual multipy::optional<THPDtype *>
  getTHPDtype(at::ScalarType scalarType) = 0;
};
