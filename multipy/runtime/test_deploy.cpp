...
//   auto session1 = replicatedObj.acquireSession(&manager);
...
//   EXPECT_THROW(manager.createMovable(obj, &session2), std::runtime_error);
//   try {
//     manager.createMovable(obj, &session2);
